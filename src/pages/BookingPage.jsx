      ...
      <Container style={{ maxWidth: '640px' }}>
        ...
        {step === 2 && (
          <div className="d-flex flex-column gap-4">
            ...
            <Card className="border-0 shadow-sm p-4 rounded-4">
              <h6 className="text-muted fw-bold mb-3">CHI TIẾT TẠM TÍNH</h6>
              <div className="d-flex justify-content-between align-items-center mb-2 small"><span className="text-muted fw-bold">Phí giữ chỗ (Booking fee)</span><span className="fw-bold text-primary">{bookingFee.toLocaleString('vi-VN')}đ</span></div>
              <div className="d-flex justify-content-between align-items-center mb-3 small"><span className="text-muted fw-bold">Phí tiện ích AI</span><span className="text-success fw-bold">Miễn phí</span></div>
              <div className="p-2 rounded-3 bg-light text-muted small d-flex align-items-center gap-2 border"><span>🛡️</span><span>Bạn có thể hoàn hủy đặt chỗ miễn phí trước giờ đặt 30 phút.</span></div>
            </Card>
