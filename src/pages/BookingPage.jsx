...
export default function BookingPage() {
  ...
  return (
    <div className="min-vh-100 d-flex justify-content-center" style={{ backgroundColor: '#222', padding: '2rem 1rem' }}>
      <div className="bg-white rounded shadow-lg d-flex flex-column" style={{ width: '100%', maxWidth: step === 3 ? '1000px' : (step === 4 ? '850px' : '700px'), minHeight: '80vh', position: 'relative', padding: '2rem' }}>
...
>>>>>>> ea1a373fc2de04509421d144a48b66465e0fccc7
        </div>
            ...
            <div className="border border-dashed rounded-4 p-4 mb-4 bg-light position-relative">
              ...
              <div className="d-flex flex-column align-items-center justify-content-center my-3">
                ...
                >
                  <img 
                    ...
                    alt="Ticket QR Code" 
                    className="img-fluid"
                    style={{ width              {/* Synchronized Lot Price & details */}
              <div className="row g-3 w-100 text-start small border-top pt-4 mt-2">
                <div className="col-6">
                  ...
                  <strong className="text-dark">{lot.title || lot.name}</strong>
                </div>
                <div className="col-6">
