// AuthPage - Trang chứa layout đăng nhập/đăng ký/quên mật khẩu và quản lý state giữa các form
...
export default function AuthPage() {
  ...
  return (
    ...
    >
      ...
      <div
        className="rounded-3 p-0 position-relative shadow-lg overflow-hidden"
        style={{ width: '100%', maxWidth: 460, background: '#ffffff' }}
      >
        {tab !== 'forgot' && (
